...
def formulaire(request):
    ...
    return render(request, 'cvApp/form.html')
...
def verification(request):
        ...
        return render(request, "cvApp/verification.html", {'address':address, 'name':name, 'email':email, 'phone':phone, 'com':com, 'interet':interet, 'langue':langue, 'experience':exp, 'objectif':objectif, 'education': education, 'project':project })
...
def generer(request, id):
    ...
    template = get_template('cvApp/generator.html')
...
def download(request):
    ...
    return render(request, 'cvApp/download.html', {'profile':profile}) 
